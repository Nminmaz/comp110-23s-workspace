...
def main() -> None:
    ...
    while major != "Quit":
        ...
        if major == "Quit":
            ...
            print("You and your competitor, a business major named Saiful will be judged on one criteria")
...
def business() -> int:
    ...
    if choice == "Pencil":
        print(f"Terrible mistake. Bana proceeded to write down the CPT theorem, demonstrating his intellect {OOF}")
...
def math(number: int) -> int:
    ...
    if number > 10:
        ...
        print("Saiful chose the lucky number 7, a much better option. Unfortunately, you have lost this test")
        ...
        print("You have passed this test and tied against Saiful in the competition.")
        points += 3
        if number == 7:
